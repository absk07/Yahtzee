...
const smallStraight = new SmallStraight({ score: 30, description: '30 points for small straights' });
const largeStraight = new LargeStraight({ score: 40, description: '40 points for large straights' });
